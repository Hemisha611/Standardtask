...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/getTalentProfile',
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/updateTalentProfile',
                                        ...
                                        >
                                            <PhotoUpload
                                               ...
                                               // savePhotoUrl='http://localhost:60290/profile/profile/updateProfilePhoto'
                                                savePhotoUrl='https://webappstandardtaskm1.azurewebsites.net'
