...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/getEmployerProfile',
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/saveEmployerProfile',
